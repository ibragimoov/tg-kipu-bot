...
export function UNIVERSITY() {
    return Markup.inlineKeyboard([
        [
            {text: 'Факультеты/Кафедры', callback_data: 'u1'},
...
export function MAGISTRACY1() {
    return Markup.inlineKeyboard([
        ...
        [
            {text: 'Можно ли учиться сразу в двух магистратурах?', callback_data: '3'},
        ],
        [
            {text: 'Магистратура, повышение квалификации и профессиональная переподготовка: как разобраться?', callback_data: '4'},
        ],
        [
            {text: 'Выбор магистратуры – проверяй, но доверяй?', callback_data: '5'},
        ],
        [
            {text: 'Как не выбрать умирающую специальность магистратуры?', callback_data: '6'},
        ],
        [
            {text: Action.BACK_FROM_ADMISSTION, callback_data: Action.BACK_FROM_ADMISSTION}
        ]
    ])
}